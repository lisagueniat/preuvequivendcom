      ...
      <div className="container max-w-5xl">
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight tracking-tight">
            Recevez des témoignages clients qui{" "}
            <span className="bg-foreground text-background px-2">convertissent</span>{" "}
            vos prochains clients
          </h1>
          
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl">
            Installez une machine à preuves sociales sur votre site. 
            Vos visiteurs deviennent des clients convaincus.
          </p>
