...
const Pricing = () => {
  ...
  return <section className="py-20 md:py-32 px-2 md:px-4 border-b-4 border-foreground border-0 shadow-sm">
        ...
        <div className="border-4 border-foreground bg-background shadow-md">
          ...
          <div className="p-4 md:p-12 shadow-none">
            ...
            <div className="mt-8 pt-8 border-t-2 border-foreground">
              ...
              <Button size="lg" className="w-full text-sm sm:text-base md:text-lg py-5 md:py-7 shadow-lg hover:shadow-xl hover:translate-x-1 hover:translate-y-1 transition-all">
