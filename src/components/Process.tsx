  ...
  return <section className="py-20 md:py-32 px-2 md:px-4 bg-foreground text-background">
      <div className="container max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-8 mt-8">
          {steps.map((step, index) => <div key={index} className="border-4 border-background p-8 md:p-8 relative group hover:-translate-y-2 transition-transform duration-300">
