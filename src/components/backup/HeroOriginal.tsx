      ...
      <div className="container max-w-5xl">
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight tracking-tight">
            ...
            <span className="bg-foreground text-background px-2">témoignages clients</span> qui convertissent 24/24
          </h1>

          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl">
            Nous installons pour vous un système qui capture et affiche les témoignages pertinents (Google, Vidéo,
            Écrit) de vos clients afin d'augmenter vos ventes.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <Button
              size="lg"
              className="text-lg px-8 py-6 shadow-md hover:shadow-lg hover:translate-x-1 hover:translate-y-1 transition-all"
            >
              Réserver un appel
            ...
            <Button
              variant="outline"
              size="lg"
              className="text-lg px-8 py-6 shadow-sm hover:shadow-md hover:translate-x-1 hover:translate-y-1 transition-all"
            >
              Découvrir l'offre
            </Button>
          </div>
